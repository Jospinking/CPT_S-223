...
// START Microassigment zone - all code you need to change is here
    ...
    LinkedList(const LinkedList<T> &other)
    {
        ...
        ListNode<T> * node = other.getFront ();
        while (node != nullptr){
    ...
    virtual LinkedList<T> &operator=(const LinkedList<T> &other)
    {
        ...
        if (&other != this){
            ...
            std::swap(temp._end, _end);
            std::swap(temp._last_accessed_node, _last_accessed_node);
            std::swap(temp._size, _size);
            std::swap(temp._last_accessed_index, _last_accessed_index);
            std::swap(temp._debug, _debug);
        }
